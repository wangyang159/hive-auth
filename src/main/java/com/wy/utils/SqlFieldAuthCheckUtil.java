...
public class SqlFieldAuthCheckUtil {
     ...
     */
    public void checkPermissions(Map<String, List<String>> tableFieldMap, String username) throws Exception {

        // 1-1、创建定长线程池 , 线程池长度  与 数据库连接池的大小 保持一致，这样每个任务都能那个一个连接
        ExecutorService executor = Executors.newFixedThreadPool(MysqlUtil.getHp_maxsize());
